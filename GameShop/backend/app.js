...
// app.use('/api/posts', require('./routes/postRoutes')); // Tạm thời comment do thiếu file postRoutes.js trên Git
...
// const postModel = require('./models/postModel'); // Tạm thời comment do thiếu file postModel.js trên Git
